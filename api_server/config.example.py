...
# Uncomment to activate OAUTH2 B2B client credentials flow based on appid claim
#  OAUTH_B2B_EXPECTED_AUDIENCE = 'https://my.expected.audience'
#  OAUTH_B2B_EXPECTED_ISSUER = 'https://my.expected.issuer'
#  OAUTH_B2B_JWKS_URL = 'https://my.expected.issuer/well-known/jwks.json'
#  OAUTH_B2B_APPID = 'xxxx'

# Uncomment to activate OAUTH2 E2E client credentials flow based on appid claim
